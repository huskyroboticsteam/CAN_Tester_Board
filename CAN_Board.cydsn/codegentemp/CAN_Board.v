// ======================================================================
// CAN_Board.v generated from TopDesign.cysch
// 04/15/2023 at 15:04
...
module top ;
	...
	wire [0:0] tmpOE__CAN1_LED_net;
	wire [0:0] tmpFB_0__CAN1_LED_net;
	wire [0:0] tmpIO_0__CAN1_LED_net;
	wire [0:0] tmpINTERRUPT_0__CAN1_LED_net;
	electrical [0:0] tmpSIOVREF__CAN1_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		CAN1_LED
		 (.oe(tmpOE__CAN1_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CAN1_LED_net[0:0]}),
		  .io({tmpIO_0__CAN1_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__CAN1_LED_net),
		  .interrupt({tmpINTERRUPT_0__CAN1_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CAN1_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CAN2_LED_net;
	wire [0:0] tmpFB_0__CAN2_LED_net;
	wire [0:0] tmpIO_0__CAN2_LED_net;
	wire [0:0] tmpINTERRUPT_0__CAN2_LED_net;
	electrical [0:0] tmpSIOVREF__CAN2_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("5ecf514f-3ab8-4207-987e-9e7477d75b93"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CAN2_LED
		 (.oe(tmpOE__CAN2_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CAN2_LED_net[0:0]}),
		  .io({tmpIO_0__CAN2_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__CAN2_LED_net),
		  .interrupt({tmpINTERRUPT_0__CAN2_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CAN2_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("6a7710ab-9fba-4011-8a4a-65aeeb86259f"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Debug1_LED_net;
	wire [0:0] tmpFB_0__Debug1_LED_net;
	wire [0:0] tmpIO_0__Debug1_LED_net;
	wire [0:0] tmpINTERRUPT_0__Debug1_LED_net;
	electrical [0:0] tmpSIOVREF__Debug1_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("35eba680-b0d6-403a-a270-b94bb814ca13"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Debug1_LED
		 (.oe(tmpOE__Debug1_LED_net),
		  .y({Net_52}),
		  .fb({tmpFB_0__Debug1_LED_net[0:0]}),
		  .io({tmpIO_0__Debug1_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Debug1_LED_net),
		  .interrupt({tmpINTERRUPT_0__Debug1_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Debug1_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Debug2_LED_net;
	wire [0:0] tmpFB_0__Debug2_LED_net;
	wire [0:0] tmpIO_0__Debug2_LED_net;
	wire [0:0] tmpINTERRUPT_0__Debug2_LED_net;
	electrical [0:0] tmpSIOVREF__Debug2_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("d41b5194-bf1e-4102-bd68-82cdeb5a0445"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Debug2_LED
		 (.oe(tmpOE__Debug2_LED_net),
		  .y({Net_28}),
		  .fb({tmpFB_0__Debug2_LED_net[0:0]}),
		  .io({tmpIO_0__Debug2_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Debug2_LED_net),
		  .interrupt({tmpINTERRUPT_0__Debug2_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Debug2_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Error1_net;
	wire [0:0] tmpFB_0__Error1_net;
	wire [0:0] tmpIO_0__Error1_net;
	wire [0:0] tmpINTERRUPT_0__Error1_net;
	electrical [0:0] tmpSIOVREF__Error1_net;

	cy_psoc3_pins_v1_10
		#(.id("57f2a0a2-aa97-4083-be0b-d05f1eed5d93"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Error1
		 (.oe(tmpOE__Error1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Error1_net[0:0]}),
		  .io({tmpIO_0__Error1_net[0:0]}),
		  .siovref(tmpSIOVREF__Error1_net),
		  .interrupt({tmpINTERRUPT_0__Error1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Error1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Error2_net;
	wire [0:0] tmpFB_0__Error2_net;
	wire [0:0] tmpIO_0__Error2_net;
	wire [0:0] tmpINTERRUPT_0__Error2_net;
	electrical [0:0] tmpSIOVREF__Error2_net;

	cy_psoc3_pins_v1_10
		#(.id("d6806d44-4c77-4653-b86a-d57f4c5dfdff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Error2
		 (.oe(tmpOE__Error2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Error2_net[0:0]}),
		  .io({tmpIO_0__Error2_net[0:0]}),
		  .siovref(tmpSIOVREF__Error2_net),
		  .interrupt({tmpINTERRUPT_0__Error2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Error2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
